  ...
  function buildHomeEnhancements(){
    ...
    const html = `<div class="ml15-shell" id="ml15-dashboard" aria-label="MortaLeague kontrol merkezi">
      <div class="ml15-grid">
        ...
        <article class="ml15-card"><div class="ml15-sectionbar"><div><span class="ml15-kicker">ÖNE ÇIKANLAR</span><h3 class="ml15-cardHeading">DEĞER ZİRVESİ</h3></div><span class="ml15-badge">CANLI</span></div><div class="ml15-list" id="ml15TopPlayers"><div class="ml15-note">Oyuncular yükleniyor...</div></div></article>
      </div>
      <div class="ml15-grid">
        <article class="ml15-card"><span class="ml15-kicker">KARİYER</span><h3 class="ml15-cardHeading">GELİŞİM İZİN</h3><p class="ml15-copy" id="ml15CareerText">Giriş yaptığında kişisel ilerleme özetin burada görünecek.</p><div class="ml15-progress"><i id="ml15CareerProgress"></i></div><div class="ml15-pills"><span class="ml15-chip" id="ml15Tier">GİRİŞ YAPILMADI</span><span class="ml15-chip" id="ml15CareerValue">€—</span></div><div class="ml15-achievements" id="ml15Achievements"></div></article>
        <article class="ml15-card"><span class="ml15-kicker">SIRALAMALAR</span><h3 class="ml15-cardHeading">OYUNCU LİDERLERİ</h3><div class="ml15-tabs"><button class="ml15-tab is-active" data-rank-mode="value">Değer</button><button class="ml15-tab" data-rank-mode="username">Alfabetik</button></div><div class="ml15-list" id="ml15Ranking"><div class="ml15-note">Veriler yükleniyor...</div></div><p class="ml15-note">Sıralama mevcut profil verilerine göre hazırlanır.</p></article>
      </div>
    </div>`;
